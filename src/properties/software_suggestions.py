"""
Software Suggestions Property Module

Handles extraction and validation of the 'software_suggestions' Codemeta property.
Suggested software
"""
...
class SoftwareSuggestionsMetadata(BaseMetadata):
    """Handles software_suggestions metadata extraction and validation."""

    CODEMETA_PROPERTY = 'sSuggestions'
    CODEMETA_TYPE = 'schema:ItemList'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract software_suggestions from raw data.

        Returns:
            Dictionary with 'sSuggestions' key containing the extracted value
        """
        # Try to extract from raw data
        value = self._get_value('sSuggestions')
    ...
    def _validate_metadata(self) -> None:
        """Validate software_suggestions metadata."""
