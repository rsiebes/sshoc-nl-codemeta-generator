"""
Software Help Property Module

Handles extraction and validation of the 'software_help' Codemeta property.
...
class SoftwareHelpMetadata(BaseMetadata):
    """Handles software_help metadata extraction and validation."""

    CODEMETA_PROPERTY = 'sHelp'
    CODEMETA_TYPE = 'schema:Text'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract software_help from raw data.

        Returns:
            Dictionary with 'sHelp' key containing the extracted value
        """
        # Try to extract from raw data
        value = self._get_value('sHelp')
    ...
    def _validate_metadata(self) -> None:
        """Validate software_help metadata."""
