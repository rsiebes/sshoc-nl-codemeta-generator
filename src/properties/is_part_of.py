"""
Is Part Of Property Module

Handles extraction and validation of the 'is_part_of' Codemeta property.
Parent software or collection
"""
...
class IsPartOfMetadata(BaseMetadata):
    """Handles is_part_of metadata extraction and validation."""

    CODEMETA_PROPERTY = 'iPartOf'
    CODEMETA_TYPE = 'schema:ItemList'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract is_part_of from raw data.

        Returns:
            Dictionary with 'iPartOf' key containing the extracted value
        """
        # Try to extract from raw data
        value = self._get_value('iPartOf')
