...
Handles extraction and validation of the 'application_sub_category' Codemeta property.
Subcategory of the software application
"""
...
class ApplicationSubCategoryMetadata(BaseMetadata):
    """Handles application_sub_category metadata extraction and validation."""

    CODEMETA_PROPERTY = 'aSubCategory'
    CODEMETA_TYPE = 'schema:Text'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract application_sub_category from raw data.

        Returns:
            Dictionary with 'aSubCategory' key containing the extracted value
        """
        # Try to extract from raw data
        value = self._get_value('aSubCategory')
    ...
    def _validate_metadata(self) -> None:
        """Validate application_sub_category metadata."""
