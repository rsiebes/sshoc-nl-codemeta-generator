"""
Supporting Data Property Module

Handles extraction and validation of the 'supporting_data' Codemeta property.
Supporting data
"""
...
class SupportingDataMetadata(BaseMetadata):
    """Handles supporting_data metadata extraction and validation."""

    CODEMETA_PROPERTY = 'sData'
    CODEMETA_TYPE = 'schema:ItemList'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract supporting_data from raw data.

        Returns:
            Dictionary with 'sData' key containing the extracted value
        """
        # Try to extract from raw data
        value = self._get_value('sData')
    ...
    def _validate_metadata(self) -> None:
        """Validate supporting_data metadata."""
