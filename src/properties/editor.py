"""
Editor Property Module

Handles extraction and validation of the 'editor' Codemeta property.
Editor(s) of the software
"""
...
class EditorMetadata(BaseMetadata):
    """Handles editor metadata extraction and validation."""

    CODEMETA_PROPERTY = 'editor'
    CODEMETA_TYPE = 'schema:ItemList'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract editor from raw data.

        Returns:
            Dictionary with 'editor' key containing the extracted value
        """
