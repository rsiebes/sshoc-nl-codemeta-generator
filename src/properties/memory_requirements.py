"""
Memory Requirements Property Module

Handles extraction and validation of the 'memory_requirements' Codemeta property.
Memory requirements
"""
...
class MemoryRequirementsMetadata(BaseMetadata):
    """Handles memory_requirements metadata extraction and validation."""

    CODEMETA_PROPERTY = 'mRequirements'
    CODEMETA_TYPE = 'schema:Text'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract memory_requirements from raw data.

        Returns:
            Dictionary with 'mRequirements' key containing the extracted value
        """
        # Try to extract from raw data
        value = self._get_value('mRequirements')
    ...
    def _validate_metadata(self) -> None:
        """Validate memory_requirements metadata."""
