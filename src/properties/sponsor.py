"""
Sponsor Property Module

Handles extraction and validation of the 'sponsor' Codemeta property.
Sponsor(s) of the software
"""
...
class SponsorMetadata(BaseMetadata):
    """Handles sponsor metadata extraction and validation."""

    CODEMETA_PROPERTY = 'sponsor'
    CODEMETA_TYPE = 'schema:ItemList'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract sponsor from raw data.

        Returns:
            Dictionary with 'sponsor' key containing the extracted value
        """
