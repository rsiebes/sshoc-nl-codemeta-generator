...
Handles extraction and validation of the 'operating_system' Codemeta property.
...
class OperatingSystemMetadata(BaseMetadata):
    """Handles operating_system metadata extraction and validation."""

    CODEMETA_PROPERTY = 'oSystem'
    CODEMETA_TYPE = 'schema:ItemList'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract operating_system from raw data.

        Returns:
            Dictionary with 'oSystem' key containing the extracted value
        """
        # Try to extract from raw data
        value = self._get_value('oSystem')
    ...
    def _validate_metadata(self) -> None:
        """Validate operating_system metadata."""
