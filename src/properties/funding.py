"""
Funding Property Module

Handles extraction and validation of the 'funding' Codemeta property.
Funding information
"""
...
class FundingMetadata(BaseMetadata):
    """Handles funding metadata extraction and validation."""

    CODEMETA_PROPERTY = 'funding'
    CODEMETA_TYPE = 'schema:ItemList'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract funding from raw data.

        Returns:
            Dictionary with 'funding' key containing the extracted value
        """
