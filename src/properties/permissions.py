"""
Permissions Property Module

Handles extraction and validation of the 'permissions' Codemeta property.
Permissions
"""
...
class PermissionsMetadata(BaseMetadata):
    """Handles permissions metadata extraction and validation."""

    CODEMETA_PROPERTY = 'permissions'
    CODEMETA_TYPE = 'schema:Text'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract permissions from raw data.

        Returns:
            Dictionary with 'permissions' key containing the extracted value
        """
