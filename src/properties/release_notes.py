"""
Release Notes Property Module

Handles extraction and validation of the 'release_notes' Codemeta property.
Release notes URL
"""
...
class ReleaseNotesMetadata(BaseMetadata):
    """Handles release_notes metadata extraction and validation."""

    CODEMETA_PROPERTY = 'rNotes'
    CODEMETA_TYPE = 'schema:Text'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract release_notes from raw data.

        Returns:
            Dictionary with 'rNotes' key containing the extracted value
        """
        # Try to extract from raw data
        value = self._get_value('rNotes')
    ...
    def _validate_metadata(self) -> None:
        """Validate release_notes metadata."""
