...
Handles extraction and validation of the 'software_requirements' Codemeta property.
...
class SoftwareRequirementsMetadata(BaseMetadata):
    """Handles software_requirements metadata extraction and validation."""
    ...
    def extract(self) -> Dict[str, Any]:
        """
        Extract software_requirements from raw data.
    ...
    def _validate_metadata(self) -> None:
        """Validate software_requirements metadata."""
