"""
Runtime Platform Property Module

Handles extraction and validation of the 'runtime_platform' Codemeta property.
Runtime platform(s) required
"""
...
class RuntimePlatformMetadata(BaseMetadata):
    """Handles runtime_platform metadata extraction and validation."""

    CODEMETA_PROPERTY = 'rPlatform'
    CODEMETA_TYPE = 'schema:ItemList'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract runtime_platform from raw data.

        Returns:
            Dictionary with 'rPlatform' key containing the extracted value
        """
        # Try to extract from raw data
        value = self._get_value('rPlatform')
    ...
    def _validate_metadata(self) -> None:
        """Validate runtime_platform metadata."""
