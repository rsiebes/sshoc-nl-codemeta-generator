"""
Publisher Property Module

Handles extraction and validation of the 'publisher' Codemeta property.
...
class PublisherMetadata(BaseMetadata):
    """Handles publisher metadata extraction and validation."""

    CODEMETA_PROPERTY = 'publisher'
    CODEMETA_TYPE = 'schema:Thing'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract publisher from raw data.

        Returns:
            Dictionary with 'publisher' key containing the extracted value
        """
