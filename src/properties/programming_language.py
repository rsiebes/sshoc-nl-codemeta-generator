...
Handles extraction and validation of the 'programming_language' Codemeta property.
...
class ProgrammingLanguageMetadata(BaseMetadata):
    """Handles programming_language metadata extraction and validation."""

    CODEMETA_PROPERTY = 'pLanguage'
    CODEMETA_TYPE = 'schema:ItemList'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract programming_language from raw data.

        Returns:
            Dictionary with 'pLanguage' key containing the extracted value
        """
        # Try to extract from raw data
        value = self._get_value('pLanguage')
    ...
    def _validate_metadata(self) -> None:
        """Validate programming_language metadata."""
