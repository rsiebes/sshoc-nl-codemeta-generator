"""
Date Published Property Module

Handles extraction and validation of the 'date_published' Codemeta property.
Date when the software was published
"""
...
class DatePublishedMetadata(BaseMetadata):
    """Handles date_published metadata extraction and validation."""

    CODEMETA_PROPERTY = 'dPublished'
    CODEMETA_TYPE = 'schema:Text'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract date_published from raw data.

        Returns:
            Dictionary with 'dPublished' key containing the extracted value
        """
        # Try to extract from raw data
        value = self._get_value('dPublished')
    ...
    def _validate_metadata(self) -> None:
        """Validate date_published metadata."""
