"""
Funder Property Module

Handles extraction and validation of the 'funder' Codemeta property.
Funder(s) of the software
"""
...
class FunderMetadata(BaseMetadata):
    """Handles funder metadata extraction and validation."""

    CODEMETA_PROPERTY = 'funder'
    CODEMETA_TYPE = 'schema:ItemList'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract funder from raw data.

        Returns:
            Dictionary with 'funder' key containing the extracted value
        """
