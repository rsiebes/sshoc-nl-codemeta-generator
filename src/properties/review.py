"""
Review Property Module

Handles extraction and validation of the 'review' Codemeta property.
Review(s) of the software
"""
...
class ReviewMetadata(BaseMetadata):
    """Handles review metadata extraction and validation."""

    CODEMETA_PROPERTY = 'review'
    CODEMETA_TYPE = 'schema:ItemList'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract review from raw data.

        Returns:
            Dictionary with 'review' key containing the extracted value
        """
