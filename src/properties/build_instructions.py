...
Handles extraction and validation of the 'build_instructions' Codemeta property.
...
class BuildInstructionsMetadata(BaseMetadata):
    """Handles build_instructions metadata extraction and validation."""

    CODEMETA_PROPERTY = 'bInstructions'
    CODEMETA_TYPE = 'schema:Text'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract build_instructions from raw data.

        Returns:
            Dictionary with 'bInstructions' key containing the extracted value
        """
        # Try to extract from raw data
        value = self._get_value('bInstructions')
    ...
    def _validate_metadata(self) -> None:
        """Validate build_instructions metadata."""
