"""
Download Url Property Module

Handles extraction and validation of the 'download_url' Codemeta property.
Download URL
"""
...
class DownloadUrlMetadata(BaseMetadata):
    """Handles download_url metadata extraction and validation."""

    CODEMETA_PROPERTY = 'dUrl'
    CODEMETA_TYPE = 'schema:Text'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract download_url from raw data.

        Returns:
            Dictionary with 'dUrl' key containing the extracted value
        """
        # Try to extract from raw data
        value = self._get_value('dUrl')
    ...
    def _validate_metadata(self) -> None:
        """Validate download_url metadata."""
