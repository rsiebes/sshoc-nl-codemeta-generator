"""
Same As Property Module

Handles extraction and validation of the 'same_as' Codemeta property.
Same as URL(s)
"""
...
class SameAsMetadata(BaseMetadata):
    """Handles same_as metadata extraction and validation."""

    CODEMETA_PROPERTY = 'sAs'
    CODEMETA_TYPE = 'schema:ItemList'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract same_as from raw data.

        Returns:
            Dictionary with 'sAs' key containing the extracted value
        """
        # Try to extract from raw data
        value = self._get_value('sAs')
