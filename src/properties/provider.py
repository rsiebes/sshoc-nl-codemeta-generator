"""
Provider Property Module

Handles extraction and validation of the 'provider' Codemeta property.
Provider(s) of the software
"""
...
class ProviderMetadata(BaseMetadata):
    """Handles provider metadata extraction and validation."""

    CODEMETA_PROPERTY = 'provider'
    CODEMETA_TYPE = 'schema:ItemList'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract provider from raw data.

        Returns:
            Dictionary with 'provider' key containing the extracted value
        """
