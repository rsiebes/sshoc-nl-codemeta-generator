...
Handles extraction and validation of the 'THE name of the software' Codemeta property.
"""
...
class NameMetadata(BaseMetadata):
    """Handles THE name of the software metadata extraction and validation."""

    def extract(self) -> Dict[str, Any]:
        """
        Extract THE name of the software from raw data.
        ...
        if cleaned_value is not None:
            self.metadata['name'] = cleaned_value
    ...
    def _validate_metadata(self) -> None:
        """Validate THE name of the software metadata."""
        ...
        if value is None:
            self.add_warning("'THE name of the software' is empty")
