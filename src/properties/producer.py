"""
Producer Property Module

Handles extraction and validation of the 'producer' Codemeta property.
Producer(s) of the software
"""
...
class ProducerMetadata(BaseMetadata):
    """Handles producer metadata extraction and validation."""

    CODEMETA_PROPERTY = 'producer'
    CODEMETA_TYPE = 'schema:ItemList'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract producer from raw data.

        Returns:
            Dictionary with 'producer' key containing the extracted value
        """
