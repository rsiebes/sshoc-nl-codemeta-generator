"""
Copyright Holder Property Module

Handles extraction and validation of the 'copyright_holder' Codemeta property.
Copyright holder(s)
"""
...
class CopyrightHolderMetadata(BaseMetadata):
    """Handles copyright_holder metadata extraction and validation."""

    CODEMETA_PROPERTY = 'cHolder'
    CODEMETA_TYPE = 'schema:ItemList'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract copyright_holder from raw data.

        Returns:
            Dictionary with 'cHolder' key containing the extracted value
        """
        # Try to extract from raw data
        value = self._get_value('cHolder')
    ...
    def _validate_metadata(self) -> None:
        """Validate copyright_holder metadata."""
