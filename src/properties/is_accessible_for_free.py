"""
Is Accessible For Free Property Module

Handles extraction and validation of the 'is_accessible_for_free' Codemeta property.
Whether accessible for free
"""
...
class IsAccessibleForFreeMetadata(BaseMetadata):
    """Handles is_accessible_for_free metadata extraction and validation."""

    CODEMETA_PROPERTY = 'iAccessibleForFree'
    CODEMETA_TYPE = 'schema:Boolean'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract is_accessible_for_free from raw data.

        Returns:
            Dictionary with 'iAccessibleForFree' key containing the extracted value
        """
        # Try to extract from raw data
        value = self._get_value('iAccessibleForFree')
    ...
    def _validate_metadata(self) -> None:
        """Validate is_accessible_for_free metadata."""
