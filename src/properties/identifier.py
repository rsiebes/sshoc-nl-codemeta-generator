...
Handles extraction and validation of the 'identifier' Codemeta property.
Unique identifier (DOI, etc.)
"""
...
class IdentifierMetadata(BaseMetadata):
    """Handles identifier metadata extraction and validation."""

    CODEMETA_PROPERTY = 'identifier'
    CODEMETA_TYPE = 'schema:Text'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract identifier from raw data.

        Returns:
            Dictionary with 'identifier' key containing the extracted value
        """
