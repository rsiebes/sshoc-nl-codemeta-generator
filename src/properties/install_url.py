"""
Install Url Property Module

Handles extraction and validation of the 'install_url' Codemeta property.
Installation URL
"""
...
class InstallUrlMetadata(BaseMetadata):
    """Handles install_url metadata extraction and validation."""

    CODEMETA_PROPERTY = 'iUrl'
    CODEMETA_TYPE = 'schema:Text'
    REQUIRED = False

    def extract(self) -> Dict[str, Any]:
        """
        Extract install_url from raw data.

        Returns:
            Dictionary with 'iUrl' key containing the extracted value
        """
        # Try to extract from raw data
        value = self._get_value('iUrl')
