#!/usr/bin/env python3
"""
Test amalgame with a modified prompt to bypass Gemini caching.
"""
...
print("=" * 80)
print("Testing amalgame with Cache-Bypass Prompt")
print("=" * 80)
print(f"\nRepository: {repo_url}\n")
...
# Create a modified prompt with timestamp to bypass caching
timestamp = int(time.time())
prompt = f"""[Request ID: {timestamp}]

Please analyze the GitHub repository at {repo_url} and extract exactly 10 meaningful keywords that describe the project.

Important: This is a fresh analysis request. Please visit the repository and analyze its current content.

For each keyword, provide:
1. The keyword itself (e.g., 'Ontology Alignment', 'Semantic Web', 'RDF')
...
print("=" * 80)
print("MODIFIED PROMPT (with cache-bypass):")
print("=" * 80)
print(prompt)
print("\n" + "=" * 80)
